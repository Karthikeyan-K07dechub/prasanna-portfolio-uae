    ...
    <section id="media-kit" className="relative px-4 py-32 md:px-16">
      <div className="pointer-events-none absolute inset-0 flex items-center justify-center">
        <div
          ...
          style={{
            background: "radial-gradient(circle at 50% 50%, rgba(233, 12, 60, 0.08) 0%, rgba(233, 12, 60, 0) 70%)",
          }}
        />
      </div>
      ...
      <div className="relative mx-auto max-w-6xl space-y-8">
        <div className="text-center">
          <span className="text-sm font-medium text-red-ribbon">For Event Organizers</span>
          <h2 className="mt-2 text-5xl font-bold">Media Kit</h2>
          <p className="mt-4 text-lg text-oslo-gray">
            Everything you need to promote Prasanna&apos;s appearance at your event.
          </p>
        </div>

        <div className="rounded-3xl border border-white/10 bg-cod-gray/50 p-10 backdrop-blur-sm">
          <div className="mb-4 flex items-center gap-3">
            <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-red-ribbon/10">
              <Mic className="h-5 w-5 text-red-ribbon" />
            </div>
            <span className="text-xs font-medium uppercase tracking-[0.1em] text-red-ribbon">Signature Keynote</span>
          </div>
          <h3 className="text-3xl font-bold">The AI Founder Advantage</h3>
          <p className="mt-4 max-w-3xl text-lg text-oslo-gray">
          ...
          <div className="mt-8 grid gap-8 md:grid-cols-2">
            <div>
              <p className="text-sm uppercase tracking-[0.1em] text-red-ribbon">Audience Will Learn</p>
            ...
            <div>
              <p className="text-sm uppercase tracking-[0.1em] text-red-ribbon">Formats Available</p>
              ...
              <p className="mt-6 text-sm uppercase tracking-[0.1em] text-red-ribbon">Other Popular Talks</p>
              <ul className="mt-3 space-y-2 text-sm text-oslo-gray">
                {otherTalks.map((talk) => (
                  <li key={talk}>• {talk}</li>
                ))}
              </ul>
          ...
          <p className="mt-8 text-sm text-oslo-gray/60">
        ...
        <div className="rounded-3xl border border-white/10 bg-cod-gray/50 p-10 backdrop-blur-sm">
          <div className="mb-6 flex flex-wrap items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-red-ribbon/10">
                <Download className="h-5 w-5 text-red-ribbon" />
              </div>
              <div>
                <span className="text-xs font-medium uppercase tracking-[0.1em] text-red-ribbon">Speaker Headshots</span>
                <p className="text-sm text-oslo-gray">7 high-resolution photos</p>
              </div>
            </div>
            <button type="button" className="inline-flex items-center gap-2 rounded-full bg-red-ribbon px-4 py-2 text-sm font-medium">
          ...
          <div className="grid gap-3 lg:grid-cols-[1fr_1.2fr]">
            <div className="relative overflow-hidden rounded-2xl bg-white/5">
              <div className="relative aspect-[3/4] min-h-[400px] bg-[#121212] w-full overflow-hidden">
                <Image
              ...
              <div className="absolute bottom-4 left-1/2 -translate-x-1/2 rounded-full bg-black/50 px-3 py-1.5 text-sm backdrop-blur-sm">
                {activeHeadshot + 1} / 7
              </div>
            </div>
                ...
                <button
                  ...
                  className={`relative aspect-square overflow-hidden rounded-xl transition-opacity ${
                    activeHeadshot === index
                      ? "ring-4 ring-red-ribbon ring-offset-2 ring-offset-cod-gray"
        ...
        <div className="grid gap-6 md:grid-cols-3">
          {[
            ...
            <div
              key={item.title}
              className="glass-card p-6 transition-all duration-300 hover:border-red-ribbon/50 hover:ring-2 hover:ring-red-ribbon/20"
            >
              <div className="mb-4 flex aspect-square items-center justify-center rounded-xl bg-white/5">
                <item.icon className="h-12 w-12 text-red-ribbon" />
              </div>
              <h3 className="text-lg font-semibold">{item.title}</h3>
              <p className="mt-1 text-sm text-oslo-gray">{item.desc}</p>
              {item.title === "Logo" ? (
                <a
                  href="/images/logo-success-resources-4b6f42.png"
                  download
                  className="mt-4 inline-flex w-full items-center justify-center gap-2 rounded-full bg-white/5 px-4 py-2.5 text-sm font-medium text-white/80 transition hover:bg-red-ribbon hover:text-white"
                >
                  <Download className="h-4 w-4" />
                  {item.action}
                </a>
                ...
                <button
                  type="button"
                  className="mt-4 flex w-full items-center justify-center gap-2 rounded-full bg-white/5 px-4 py-2.5 text-sm font-medium text-white/80 transition hover:bg-red-ribbon hover:text-white"
                >
                  <Download className="h-4 w-4" />
                  {item.action}
                </button>
        ...
        <div className="rounded-2xl border border-white/5 bg-cod-gray/30 p-8 text-center">
          ...
          <p className="mt-2 text-sm text-oslo-gray/60">
