  ...
  return (
    <PortfolioSection id="about" eyebrow="01 / Meet the founder" title={<>A multidisciplinary <span className="font-playfair italic">perspective.</span></>}>
      <div className="grid items-center gap-10 lg:grid-cols-[0.85fr_1.15fr] lg:gap-16">
        <div className="relative mx-auto aspect-[3/4] w-full max-w-md overflow-hidden rounded-3xl border border-black/10">
        ...
        <div className="space-y-6 text-base leading-8 text-black sm:text-lg">
          ...
          <div className="grid gap-5 border-t border-black/15 pt-6 sm:grid-cols-2">
            <div><p className="text-xs font-semibold uppercase tracking-widest">Professional focus</p><p className="mt-2 text-base leading-7">India &amp; UAE</p></div>
