...
const insights = [
  { category: "AI & Business", title: "Start with the business problem", description: "Prasanna’s perspective on applying AI to customer experience, operations, and business growth.", href: "https://www.linkedin.com/posts/prasanna-el-13a6b27a_ai-artificialintelligence-businessgrowth-activity-7491120641643978756-EYqf" },
      ...
      <div className="grid gap-6 lg:grid-cols-3">
        {insights.map(item => (
          <article key={item.title} className="flex h-full flex-col rounded-2xl border border-black/15 bg-white p-6 sm:p-8">
            ...
            <p className="mb-8 mt-4 flex-1 text-base leading-7">{item.description}</p>
